export const meta = {
  title: "Jak zostać frontend developerem?",
  seo_desc:
    "Pytanie 'Jak zostać frontend developerem' coraz częściej pojawia się na forach i grupach społeczonściowych. Postaram się odpowiedzieć na to pytanie.",
  short:
